...
/// <summary>
/// Provides MVC actions for the home pages (Index, Privacy, About, Contact, and error pages).
/// Anti-pattern demo pages have been moved to <see cref="DemoController"/> and <see cref="ProfileController"/>.
/// </summary>
